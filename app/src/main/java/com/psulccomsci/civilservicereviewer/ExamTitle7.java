...
public class ExamTitle7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tempx = PhilippineConstitution.temp();
        ...
        countDownTimer = new CountDownTimer(2000, 1000) {
            ...
            public void onFinish() {
                Intent intent = new Intent(getApplicationContext(), NumericalReasoning.class);
