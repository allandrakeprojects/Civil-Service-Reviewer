...
public class test7 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ANS = db.rawQuery(" SELECT "+ npdbhelper.col_philconsAns+" FROM "+ npdbhelper.table_answer + " where " +npdbhelper.col_ans_1
                +" = "+random,null);
        AA = db.rawQuery(" SELECT "+ npdbhelper.col_choice_1+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
                +" = "+random,null);
        BB = db.rawQuery(" SELECT "+ npdbhelper.col_choice_2+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
                +" = "+random,null);
        CC = db.rawQuery(" SELECT "+ npdbhelper.col_choice_3+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
                +" = "+random,null);
        DD = db.rawQuery(" SELECT "+ npdbhelper.col_choice_4+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
                +" = "+random,null);
        EE = db.rawQuery(" SELECT "+ npdbhelper.col_choice_5+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
                +" = "+random,null);
        QQ = db.rawQuery(" SELECT "+ npdbhelper.col_philconsQ+" FROM "+ npdbhelper.table_quest + " where " +npdbhelper.col_quest_1
                +" = "+random,null);
        //This area is for adding the generated Math solutions, but for now temporary unavailable.
//        solN = db.rawQuery(" SELECT "+ npdbhelper.col_solN+" FROM "+ npdbhelper.table_philcons + " where " +npdbhelper.col_choice_id
//                        +" = "+random,null);
