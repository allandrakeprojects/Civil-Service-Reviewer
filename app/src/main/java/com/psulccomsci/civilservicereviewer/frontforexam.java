...
public class frontforexam extends AppCompatActivity {
    TextToSpeech warning1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_frontforexam);
        ...
        ((ImageButton) findViewById(R.id.chat)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbhelper myDbHelper = new dbhelper(frontforexam.this);
                try {
                ...
                Intent intent = new Intent(getApplicationContext(),preload_exam.class);
