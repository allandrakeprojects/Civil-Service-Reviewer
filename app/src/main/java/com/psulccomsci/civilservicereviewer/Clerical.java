...
public class Clerical extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ANS = db.rawQuery(" SELECT "+ dbhelper.col_clerAns+" FROM "+ dbhelper.table_answer + " where " +dbhelper.col_ans_1
                +" = "+random,null);
        AA = db.rawQuery(" SELECT "+ dbhelper.col_choice_1+" FROM "+ dbhelper.table_clerical + " where " +dbhelper.col_choice_id
                +" = "+random,null);
        BB = db.rawQuery(" SELECT "+ dbhelper.col_choice_2+" FROM "+ dbhelper.table_clerical + " where " +dbhelper.col_choice_id
                +" = "+random,null);
        CC = db.rawQuery(" SELECT "+ dbhelper.col_choice_3+" FROM "+ dbhelper.table_clerical + " where " +dbhelper.col_choice_id
                +" = "+random,null);
        DD = db.rawQuery(" SELECT "+ dbhelper.col_choice_4+" FROM "+ dbhelper.table_clerical + " where " +dbhelper.col_choice_id
                +" = "+random,null);
        EE = db.rawQuery(" SELECT "+ dbhelper.col_choice_5+" FROM "+ dbhelper.table_clerical + " where " +dbhelper.col_choice_id
                +" = "+random,null);
        QQ = db.rawQuery(" SELECT "+ dbhelper.col_clericalQ+" FROM "+ dbhelper.table_quest + " where " +dbhelper.col_quest_1
                +" = "+random,null);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                A = AA.getString(0);B = BB.getString(0);C = CC.getString(0);D = DD.getString(0);E = EE.getString(0);Q = QQ.getString(0);ans = ANS.getString(0);
                first.setText(A);second.setText(B);third.setText(C);fourth.setText(D);fifth.setText(E);quest.setText(Q);
                }else{Intent intent=new Intent(getApplicationContext(),ExamTitle6.class);
    ...
    public void Clericalchecking(){
        ClericalCorrect correct = new ClericalCorrect();
